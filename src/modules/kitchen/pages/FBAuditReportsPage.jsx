        ...
        <div className="rounded-2xl bg-white border border-slate-200 p-6 shadow-sm">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 border border-emerald-200 shadow-sm shrink-0">
            ...
            <div className="flex items-center gap-2.5 flex-wrap w-full lg:w-auto justify-end">
              <Link
                to="/kitchen/audit"
                className="flex items-center gap-2 px-3.5 py-2 text-xs font-medium rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 transition"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-xs font-semibold rounded-xl bg-slate-900 text-white hover:bg-slate-800 transition shadow-sm"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-3.5 py-2 text-xs font-medium rounded-xl bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 transition shadow-sm"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="text-xs text-slate-500 mt-1">
                Kitchen: {metrics.totalKitchenUnits.toLocaleString()} &bull; Bar: {metrics.totalBarUnits.toLocaleString()} units
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="text-xs text-slate-500 mt-1">
                {metrics.totalHealthy} items healthy &bull; {metrics.totalLow} low stock alerts
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="text-xs text-slate-500 mt-1">
                {metrics.kitchenDepleted} in Kitchen &bull; {metrics.barDepleted} in Bar
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="text-xs text-slate-500 mt-1">
                {audits.length} recorded audit inspections in history
              </p>
            </div>
          </div>
              ...
              <div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-orange-50 text-orange-600 border border-orange-200">
                      <UtensilsCrossed className="h-5 w-5" />
                    </div>
                    <div>
                      <h3 className="font-bold text-slate-900 text-base">Kitchen Operations</h3>
                      <p className="text-xs text-slate-500">Food, starters, grills & prep lines</p>
                    </div>
                  </div>
                  <span className="px-2.5 py-1 text-xs font-bold rounded-lg bg-orange-50 text-orange-700 border border-orange-200">
                ...
                <div className="grid grid-cols-3 gap-3 mt-6 pt-5 border-t border-slate-100 text-center">
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <p className="text-[11px] font-semibold text-slate-400 uppercase">Stock On Hand</p>
                    <p className="text-base font-extrabold text-slate-900 mt-1">
                      {metrics.totalKitchenUnits.toLocaleString()} units
                    </p>
                  </div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <p className="text-[11px] font-semibold text-slate-400 uppercase">Low / Zero</p>
                    <p className="text-base font-extrabold text-rose-600 mt-1">
                      {metrics.kitchenDepleted} / {metrics.kitchenLow}
                    </p>
                  </div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <p className="text-[11px] font-semibold text-slate-400 uppercase">Active Prep</p>
              ...
              <div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h3 className="font-bold text-slate-900 text-base">Bar Operations</h3>
                ...
                <div className="grid grid-cols-3 gap-3 mt-6 pt-5 border-t border-slate-100 text-center">
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <p className="text-[11px] font-semibold text-slate-400 uppercase">Stock On Hand</p>
                    <p className="text-base font-extrabold text-slate-900 mt-1">
                      {metrics.totalBarUnits.toLocaleString()} units
                    </p>
                  </div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <p className="text-[11px] font-semibold text-slate-400 uppercase">Low / Zero</p>
                  ...
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <p className="text-[11px] font-semibold text-slate-400 uppercase">Active Orders</p>
          ...
          {topConsumedItems.length > 0 && (
            <div className="rounded-2xl bg-white border border-slate-200 p-6 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs text-slate-500">Ranked by real POS orders</span>
              </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
            <div className="flex items-center gap-1.5 bg-slate-100 p-1.5 rounded-2xl w-fit flex-wrap">
              ...
              >
                ...
                <span>All F&B Stock Inventory ({filteredItemsAnalysis.length})</span>
              </button>
              ...
              >
                ...
                <span>Audit Logs & Approvals ({filteredAudits.length})</span>
              </button>
            ...
            <div className="text-xs text-slate-500 flex items-center gap-2">
              <span className="font-bold text-slate-900">{itemsAnalysis.length}</span> total catalog items &bull;
              <span className="font-bold text-slate-900">{audits.length}</span> audit logs
            </div>
          </div>
                ...
                <div className="flex items-center gap-2.5 flex-wrap">
                  ...
                  <div className="flex items-center gap-1 bg-slate-50 p-1 rounded-xl border border-slate-200 flex-wrap">
                    {[
                      ...
                      { id: "depleted", label: `Zero Stock (${metrics.totalDepleted})` },
                      {
